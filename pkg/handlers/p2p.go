...
// HandleP2PCreate creates a new P2P room and returns the room ID
...
// HandleP2PSignal receives a signal and stores it in the room
...
// HandleP2PPoll returns new signals for a role since a given index
func HandleP2PPoll(w http.ResponseWriter, r *http.Request) {
	...
	// Return signals that are NOT from this role
	room.mu.Lock()
